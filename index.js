...
const eBday = new Date('Sept 24, 1996')
const eAge = today - eBday
const age = today - bday 
console.log(age, '<- Age in ms')
console.log('age in seconds')
console.log(eAge / 1000)
console.log('age in mins')
console.log(eAge / 1000 / 60)
console.log('age in hours')
console.log(eAge / 1000 / 3600)
console.log('age in days')
console.log(eAge / 1000 / 3600 / 24)
console.log('age in years')
console.log(eAge / 1000 / 3600 / 24 / 365)
...
console.log('b day of month')
console.log(months[eBday.getMonth()])
...
function consecutiveDates(date, repeat, offset) {
  ...
  for (let i = 0; i < repeat; i++) {
    ...
    schedule.push(nextDate.toISOString().substring(0, 10))
  }
  return schedule
}
...
console.log('day of week of birthday')
whensYourParty(bday, 2022)
whensYourParty(bday, 1996)
console.log(whensYourParty(bday, 2002))
